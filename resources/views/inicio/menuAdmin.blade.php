    ...
    @if(accesoUser([1]))
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua" style="box-shadow: 0px 10px 30px 0px #8d8686;">
            ...
            <a href="{{ URL::to('procetramites')}}" id="recibosH" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
          </div>
        </div>
...
@endif
        ...
        <div class="col-lg-3 col-xs-6">
		  ...
		  <a href="{{URL::to('usuarios')}}" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
		   </div>
        </div>
@endif
...
<i class="fa fa-envelope    "></i> 
    ...
    <a href="{{ URL::to('usuariosmail')}}" id="recibosP" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
  </div>
</div>
...
<i class="fa fa-list-alt"></i> 
    ...
    <a href="{{ URL::to('tipodocumento')}}" id="recibosP" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
  </div>
</div>
...
@if(accesoUser([1]))
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="box-shadow: 0px 10px 30px 0px #8d8686;">
			...
			<a href="{{ URL::to('unidadorganica')}}" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
          </div>
        </div>
...
@if(accesoUser([1]))
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red" style="box-shadow: 0px 10px 30px 0px #8d8686;">
			...
			<a href="{{ URL::to('entidad')}}" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
          </div>
        </div>
@endif
...
@if(accesoUser([1]))
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue" style="box-shadow: 0px 10px 30px 0px #8d8686;">
			...
			<a href="{{ URL::to('prioridad')}}" class="small-box-footer" style="height: 37px"><i class="fa fa-arrow-circle-right" style="font-size: 30px"></i></a>
          </div>
        </div>
