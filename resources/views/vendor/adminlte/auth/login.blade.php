...
<body id="headerwrap" class="withAnimation">
    ...
    <div class="parallax-viewport" id="parallax">
       ...
       {{--  <div class="parallax-layer cloud4" style="top: 0%; margin-top: -11.9391px; left: 90%; margin-left: -402.003px;">
            <img src="{{ asset('/login/images/sun.png') }}" alt="" width="200"> 
        </div> --}}
    ...
    <div class="d-flex justify-content-center h-100">
                ...
                @if (count($errors) > 0)
                    ...
                    <div class="alert alert-danger" style="margin-bottom: 0px;margin-top: 30px;">
                        ...
                        <ul style="margin-bottom: 0px;">
                            ...
                            <li>Usted ha ingresado un nombre de usuario o un password incorrecto. Si no recuerda el usuario y password correcto, comuníquese con el área de estadística</li>
                            @endif
        ...
        <div class="card">
            ...
            <div class="card-header" style="padding-left: 25px;padding-right: 25px;border-bottom: 1px solid rgba(255, 195, 18, 0.54);">
                ...
                <h5 style="margin-top: 15px; color: white;"><font face="Arial">Corte Superior de Justicia de Ancash</font></h5>
