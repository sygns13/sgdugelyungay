<div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Gestión de Entidades Externas</h3>
         ...
         <div class="box-body">
          ...
          <div class="col-md-12" >
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="txtnombre" name="txtnombre" placeholder="Nombre" maxlength="500" autofocus v-model="newnombre" required>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12" style="padding-top: 15px;">
              ...
              <div class="form-group">
                <label for="txtsiglas" class="col-sm-2 control-label">SIGLAS de la Entidad:*</label>
    ...
    <div class="box-body table-responsive">
      <table class="table table-hover table-bordered" >
        <tbody><tr>
          ...
          <th style="padding: 5px; width: 25%;">Entidad</th>
        ...
        <tr v-for="entidad, key in entidads">
          ...
          <td style="font-size: 12px; padding: 5px;">{{ entidad.nombre }}</td>
          <td style="font-size: 12px; padding: 5px;">{{ entidad.codigo }}</td>
          <td style="font-size: 12px; padding: 5px;">{{ entidad.siglas }}</td>
          <td style="font-size: 12px; padding: 5px;">{{ entidad.abrev }}</td>
          <td style="font-size: 12px; padding: 5px;">
           <span class="label label-success" v-if="entidad.activo=='1'">Activo</span>
           <span class="label label-warning" v-if="entidad.activo=='0'">Inactivo</span>
         </td>
         <td style="font-size: 12px; padding: 5px;">
  
           <a href="#" v-if="entidad.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="baja(entidad)" data-placement="top" data-toggle="tooltip" title="Desactivar Entidad"><i class="fa fa-arrow-circle-down"></i></a>
  
           <a href="#" v-if="entidad.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="alta(entidad)" data-placement="top" data-toggle="tooltip" title="Activar Entidad"><i class="fa fa-check-circle"></i></a>
  
  
           <a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editar(entidad)" data-placement="top" data-toggle="tooltip" title="Editar Entidad"><i class="fa fa-edit"></i></a>
           <a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrar(entidad)" data-placement="top" data-toggle="tooltip" title="Borrar Entidad"><i class="fa fa-trash"></i></a>
         </td>
       </tr>
  ...
  <form method="post" v-on:submit.prevent="update(fillentidad.id)">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="txtnombreE" name="txtnombreE" placeholder="Descripción" maxlength="500" autofocus v-model="fillentidad.nombre" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12" style="padding-top: 15px;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="txtcodigoE" name="txtcodigoE" placeholder="Código" maxlength="45"  v-model="fillentidad.codigo">
                          </div>
                        </div>
                      ...
                      <div class="col-md-12" style="padding-top: 15px;">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="txtsiglasE" name="txtsiglasE" placeholder="SIGLAS" maxlength="45"  v-model="fillentidad.siglas">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12" style="padding-top: 15px;">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="txtabrevE" name="txtabrevE" placeholder="Abreviatura" maxlength="45"  v-model="fillentidad.abrev">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12" style="padding-top: 15px;">
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" id="cbuestadoE" name="cbuestadoE" v-model="fillentidad.activo">
                              <option value="1">Activado</option>
                              <option value="0">Desactivado</option>
                            </select>
                          </div>
