<div class="box box-info" id="divparte1">
  <div class="box-header with-border">
    <h3 class="box-title">Gestión de Mis Trámites</h3>
    ...
    <a style="float: right;    " type="button" class="btn btn-warning" href="<?php echo e(URL::to('reghistoricos')); ?>"><i class="fa fa-archive" aria-hidden="true"></i> 
